...
export default function RegisterPage(){
    ...
    const handleSubmit=(event)=>{
        ...
        if (!inputs.phoneNumber.trim().match(phoneRegex)) {
        ...
        if(!hasError){
            ...
            RegisterApi(inputs).then((response)=>{
                if(response.data.error!=null){
                    ...
                    errors.custom_error=response.data.error;
              ...
              <div className="col register-sec">
                ...
                <form onSubmit={handleSubmit} className="register-form" action="" >
                 ...
                 <div className="form-group">
                    ...
                    errors.password.required==true?
                    (<span className="text-danger" >
                        Password should Contains at least 8 charactersc,includes both numbers,uppercase and lowercase letters.
                    </span>):null
                    }
                 </div>
                 <div className="form-group">
                    ...
                    errors.phoneNumber.required==true?
                        (<span className="text-danger" >
                         Phone Number should contains 10 digit and start with 0.
                    </span>):null
                    }
                 </div>
                 <div className="form-group">
