          ...
          {Object.keys(mobile).length === 0 ? (
            ...
            <>
              ...
              <div className="">
                <p>
                  Display:{" "}
                  {mobile.description ? mobile.description.Display : ""}
                </p>
                <p>
                  Performance:{" "}
                  {mobile.description ? mobile.description.Performance : ""}
                </p>
                <p>Ram: {mobile.description ? mobile.description.RAM : ""}</p>
                <p>
                  Storage:{" "}
                  {mobile.description ? mobile.description.Storage : ""}
                </p>
                <p>
                  Battery Life:{" "}
                  {mobile.description ? mobile.description["Battery Life"] : ""}
                </p>
                <p>
                  Camera System:{" "}
                  {mobile.description
                    ? mobile.description["Camera System"]
                    : ""}
                </p>
                <p>
                  Other Features:{" "}
                  {mobile.description
                    ? mobile.description["Other Features"]
                    : ""}
                </p>
                <p>
                  Colors: {mobile.description ? mobile.description.Colors : ""}
                </p>
              </div>
              ...
              <div>
                {isAuthenticated() ? (
                  <button
                    ...
                    onClick={() => {
                      handleAddToCart(user.localId, mobile.id);
                    }}
                  >
                    Add to Cart
                  </button>
